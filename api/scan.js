  ...
  try {
    ...
    if (error.message?.includes('API_KEY_HTTP_REFERRER_BLOCKED')) {
      return res.status(403).json({ 
        error: 'API key has referrer restrictions. Please remove HTTP referrer restrictions in Google Cloud Console or add your domain to allowed referrers.' 
      });
    }
