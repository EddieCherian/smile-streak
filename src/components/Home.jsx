...
import { LogOut, RefreshCw, MessageCircle, X, Globe, Check, Languages, Moon, Sun, Image } from "lucide-react";
  ...
  useEffect(() => {
    ...
    getDoc(ref).then((snap) => {
      if (snap.exists()) {
        ...
        if (data.userProfile?.darkMode !== undefined) {
                        ...
                        {[1, 2, 3, 4, 5].map((rating) => (
                          <label key={rating} className="cursor-pointer">
                            ...
                            <div className={`w-12 h-12 flex items-center justify-center border-2 rounded-xl transition-all ${
                              darkMode
                                ? 'border-gray-600 peer-checked:border-blue-500 peer-checked:bg-blue-900/30 hover:border-blue-500'
                                : 'border-gray-200 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-blue-300'
                            }`}>
